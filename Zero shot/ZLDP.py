...
for test_id in tqdm(subject_ids, desc="LOSO-CV"):
    ...
    for _, row in test_df.iterrows():
        ...
        prompt = (
            "You are a helpful assistant that predicts depression risk using the input features."
            " Given the features below, output only the digit '0' or '1' to predict depression with no explanation."
