...
target_col = "High Burden"  # or replace with the appropriate target column if different
text_column = "UNI"
...
for test_id in tqdm(subject_ids, desc="LOSO-CV"):
    ...
    for _, row in test_df.iterrows():
        ...
        prompt = (
            "You are a helpful assistant that predicts high burden risk using the input."
            " Based on the narrative below, output only the digit '0' or '1' with no explanation to predict high burden."
