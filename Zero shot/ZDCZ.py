...
for test_id in tqdm(subject_ids, desc="LOSO-CV"):
    ...
    for _, row in test_df.iterrows():
        ...
        prompt = (
            "You are a helpful assistant that predicts high burden risk using the features."
            " Given the features below, output only the digit '0' or '1' with no explanation to predict high burden."
            "\n\nImportant:"
